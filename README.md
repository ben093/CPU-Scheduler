...
The program must be implemented with multiple source files (the design of the modules is up to you), be compile-able through command make (your makefile should reflect the dependency of each binary module to other files), and be executable on the command line with:
